          ...
          <div className="text-center mb-8 relative z-20">
            <h1 className="text-7xl lg:text-9xl font-bold mb-6 leading-tight">
              ...
              <span className="text-4xl lg:text-6xl text-white/90 font-light">
                Claim your identity. Build your reality.
              </span>
            </h1>

            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              You've just been invited to the new theme park of AI — this is only the entry gate. You haven't seen what's on the roadmap.
            </p>

            {/* Countdown Bar */}
            <div className="mb-12">
              <div className="bg-black/70 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 max-w-md mx-auto">
                <p className="text-cyan-400 text-sm mb-2 text-center">☀️ Sunrise Phase ends in:</p>
