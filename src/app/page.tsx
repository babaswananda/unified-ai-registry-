      ...
      <section className="relative z-20 py-16 bg-gradient-to-r from-purple-500/5 to-cyan-500/5 border-y border-purple-500/20">
        <div className="container-max section-padding">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {/* Digital ID Wallet */}
            <div className="bg-black/50 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-bold text-cyan-400 mb-4">🪪 .digitalidwallet – The Root Identity Layer</h3>
              ...
              <p className="text-cyan-400 font-bold mt-6">This is your new operating system for the internet. Every human, creator, business, and agency runs through it.</p>
            </div>

            {/* AI Marketplace */}
            <div className="bg-black/50 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-bold text-cyan-400 mb-4">🛍️ .aimarketplace – The Intelligence Commerce Network</h3>
              ...
              <p className="text-cyan-400 font-bold">Think Shopify meets programmable agents — but built for the autonomous era.</p>
            </div>

            {/* AI Directory */}
            <div className="bg-black/50 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-bold text-cyan-400 mb-4">📇 .aidirectory – The Master Registry of AI Handles & Agents</h3>
              <div className="space-y-3 mb-6">
                <div className="flex items-start space-x-3">
                  <span className="text-cyan-400 font-bold">•</span>
              ...
              <p className="text-cyan-400 font-bold">This is the yellow pages of the new internet — intelligent, decentralized, and self-sovereign.</p>
            </div>

            {/* Dev Community Portal */}
            <div className="bg-black/50 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-bold text-cyan-400 mb-4">🧑‍💻 Dev Community Portal</h3>
              <div className="space-y-3 mb-6">
                <div className="flex items-start space-x-3">
                  <span className="text-cyan-400 font-bold">•</span>
              ...
              <p className="text-cyan-400 font-bold">Every dev is issued a wallet + workspace — no accounts, no dependencies.</p>
            </div>
          </div>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <div className="bg-black/50 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-bold text-cyan-400 mb-4">💰 Get.Paid</h3>
              <div className="space-y-3 mb-6">
                <div className="flex items-start space-x-3">
                  <span className="text-cyan-400 font-bold">•</span>
              ...
              <p className="text-cyan-400 font-bold">Handles powered by .digitalidwallet plug in directly. No middlemen, ever.</p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 max-w-6xl mx-auto">
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <div className="font-mono text-cyan-400 font-bold">.digitalidwallet</div>
                <div className="text-gray-300 text-sm">root identity</div>
              </div>
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <div className="font-mono text-cyan-400 font-bold">.aimarketplace</div>
                <div className="text-gray-300 text-sm">service layer</div>
              </div>
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <div className="font-mono text-cyan-400 font-bold">.aidirectory</div>
                <div className="text-gray-300 text-sm">discovery layer</div>
              </div>
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <div className="font-mono text-cyan-400 font-bold">Get.Paid</div>
                <div className="text-gray-300 text-sm">monetization rails</div>
              </div>
              <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-4">
                <div className="font-mono text-cyan-400 font-bold">All other TLDs</div>
          ...
          <div className="mt-16 text-center max-w-5xl mx-auto">
            <div className="bg-gradient-to-r from-cyan-500/10 to-cyan-500/10 border border-cyan-500/20 rounded-lg p-8">
